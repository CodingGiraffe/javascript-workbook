...
const stringsToNumbs = strNums.map(number => parseInt(number, 10))

console.log(stringsToNumbs)

// With the same numbers, find the sum of the even values
const arrayToEvens = stringsToNumbs.filter(number => number % 2 == 0)
const sumEvens = arrayToEvens.reduce((acc, curr) => acc + curr)
...
const weatherStates = [...new Set(weather.map(el => el.weather_state_name))]
